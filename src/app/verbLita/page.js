...
/* import "../../../public/norsk/verbLita.css"; */
  ...
  useEffect(() => {
    ...
    function createFlashcard(tag, ui, data, state) {
      ...
      function handleAnswerInput() {
        const input = ui.answerElement.value.trim().toLowerCase();
        const correct = currentCardWord().toLowerCase();
    ...
    const game = createFlashcard(tag, ui, savedData || data, savedState);
